...
class TestImplementation:
    ...
    def test_imports(self):
        ...
        assert mcp is not None, "FastMCP server instance not found" # type: ignore
        assert callable(analyze_file_changes), "analyze_file_changes should be a callable function" # type: ignore
        assert callable(get_pr_templates), "get_pr_templates should be a callable function"   # type: ignore
        assert callable(suggest_template), "suggest_template should be a callable function"  # type: ignore
...
class TestAnalyzeFileChanges:
    ...
    async def test_returns_json_string(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            result = await analyze_file_changes() # type: ignore
    ...
    async def test_output_limiting(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            result = await analyze_file_changes(include_diff=True) # type: ignore
            data = json.loads(result)
...
class TestGetPRTemplates:
    ...
    async def test_returns_json_string(self):
        ...
        result = await get_pr_templates() # type: ignore
...
class TestSuggestTemplate:
    ...
    async def test_returns_json_string(self):
        ...
        result = await suggest_template( # type: ignore
...
class TestToolRegistration:
    ...
    def test_tools_have_decorators(self):
        ...
        assert hasattr(analyze_file_changes, '__name__'), "analyze_file_changes should be a proper function"  # type: ignore
        assert hasattr(get_pr_templates, '__name__'), "get_pr_templates should be a proper function" # type: ignore
        assert hasattr(suggest_template, '__name__'), "suggest_template should be a proper function" # type: ignore


if __name__ == "__main__":
    if not IMPORTS_SUCCESSFUL:
        print(f"❌ Cannot run tests - imports failed: {IMPORT_ERROR}") # type: ignore
        print("\nMake sure you've:")
